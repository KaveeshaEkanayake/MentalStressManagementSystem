...
export const register = async (req, res)=>{
    ...
    try {
        ...
        const mailOptions = {
            ...
            text: `Hello ${name}, Welcome to CheerUP website Your account has been created with email id: ${email}`
        }
...
export const verifyEmail = async (req, res)=>{
    ...
    try {
        ...
        if(user.verifyOtpExpireAt < Date.now()){
             return res.json({ success: false, message: 'OTP expired.It only valid for 24 hours'});
        }
 ...
 export const resetPassword = async (req,res)=>{
    ...
    try {
        ...
        if(user.resetOtpExpireAt < Date.now()){
            return res.json({success: false, message:'OTP expired.OTP valid only for 15 minutes' });
