...
const Login = () => {
  ...
  return (
    <div className='flex items-center justify-center min-h-screen px-6 sm:px-0 bg-gradient-to-br from-blue-100 to-purple-500'>
      <h2 onClick={()=>navigate('/')} className='text-3xl font-semibold text-indigo-700 absolute left-5 sm:left-20 top-5 w-28 sm:w-32 cursor-pointer'>CheerUP</h2>
